          ...
          <div className="lg:col-span-2">
              ...
              <HoverLift>
                <div className="card overflow-hidden">
                  <div className="relative w-full" style={{ paddingTop: "160px" }}>
                    {/* If the provider blocks iframes, the buttons below handle it */}
                    <iframe
            ...
            <Reveal delay={0.1}>
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <p className="text-xs text-[var(--ink-600)] w-full">
              ...
              <noscript>
                <p className="mt-3">
                  ...
                  <a className="underline" href={GIVELIFY_URL}>
                    this link
                  </a>.
                </p>
              </noscript>
      ...
      <section className="section" aria-labelledby="other-ways">
        <div className="container-1200 grid md:grid-cols-3 gap-6">
          {[
            {
              t: "In Person",
              b: "Place cash or checks in the giving boxes during any service.",
            },
            {
              t: "By Mail",
              b: "Saint Mark Cathedral, 1234 Example St, Wichita, KS 672xx. Make checks payable to “Saint Mark Cathedral.”",
            },
            {
              t: "Text to Give",
              b: "If enabled on Givelify, include your church’s dedicated text-to-give number here.",
            },
          ].map((x, i) => (
            <Reveal key={x.t} delay={i * 0.06}>
              <HoverLift>
                <div className="card p-6 h-full">
                  ...
                  <p className="text-sm text-[var(--ink-600)] mt-2">{x.b}</p>
                </div>
              </HoverLift>
            </Reveal>
          ))}
        ...
        <HeroFade>
          ...
          <div className="mt-6">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn bg-white text-[var(--indigo-900)]"
            >
              Open Secure Giving
            </a>
          </div>
